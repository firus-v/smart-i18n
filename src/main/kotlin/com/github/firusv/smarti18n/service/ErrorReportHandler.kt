...
/**
 * Легкая отправка отчета об ошибках в репозиторий проекта, если происходят исключения.
 * @author firusv
 */
class ErrorReportHandler : ErrorReportSubmitter() {
    ...
    override fun submit(
        ...
        val plugin: IdeaPluginDescriptor? = PluginManagerCore.getPlugin(PluginId.getId("de.marhali.easyi18n"))
        ...
        var url = "https://github.com/marhali/easy-i18n/issues/new?title=" +
